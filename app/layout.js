...
// Hapus import ThemeProvider lama jika masih ada (misal dari "./components/ThemeProvider")
// import { ThemeProvider } from "./components/ThemeProvider";

import { Providers } from './Providers'; // <-- PENTING: Import Providers baru dari app/providers.js
import { SessionProvider } from 'next-auth/react'; // <-- PENTING: Import SessionProvider
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className={inter.className}>
        {/* PENTING: SessionProvider harus membungkus semua komponen yang menggunakan useSession */}
        <SessionProvider>
          <Providers> {/* Providers Anda yang sudah ada */}
            {children}
          </Providers>
        </SessionProvider>
        <SpeedInsights />
